...
if(isset($_POST['update']))
  {
$d_id=$item['d_id'];
//$item_q=$_GET["quantity"]
$p_id+= $item["quantity"]; 
//$status=$_POST['status'];
//$remark=$_POST['remark'];
//$query=mysqli_query($db,"insert into dishes(frm_id,status,remark) values('$form_id','$status','$remark')");
$sql=mysqli_query($db,"update dishes set P_ID='$p_id' where d_id='$d_id'");
